...
type TasksClient interface {
	...
	UpdateTask(ctx context.Context, in *UpdateTaskRequest, opts ...grpc.CallOption) (*UpdateTaskRequest, error)
...
func (c *tasksClient) UpdateTask(ctx context.Context, in *UpdateTaskRequest, opts ...grpc.CallOption) (*UpdateTaskRequest, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateTaskRequest)
...
type TasksServer interface {
	...
	UpdateTask(context.Context, *UpdateTaskRequest) (*UpdateTaskRequest, error)
...
func (UnimplementedTasksServer) UpdateTask(context.Context, *UpdateTaskRequest) (*UpdateTaskRequest, error) {
